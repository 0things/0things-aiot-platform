...
export function AccountForm() {
  ...
  const accountFormSchema = z.object({
    name: z
      ...
      .max(30, t('account.validation.nameMaxLength')),
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>{t('account.name.description')}</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
            ...
            <FormItem className='flex flex-col'>
              ...
              <Popover>
                ...
                <PopoverContent className='w-[200px] p-0'>
                  <Command>
                    <CommandInput
                      placeholder={t('account.language.searchPlaceholder')}
                    />
                    <CommandEmpty>
                      {t('account.language.noLanguageFound')}
                    </CommandEmpty>
                    <CommandGroup>
                      <CommandList>
        ...
        />
        <Button type='submit'>{t('account.updateButton')}</Button>
      </form>
    </Form>
  )
}
