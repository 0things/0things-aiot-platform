...
const (
	EventService_PublishEvent_FullMethodName = "/api.event.v1.EventService/PublishEvent"
)
...
func (c *eventServiceClient) PublishEvent(ctx context.Context, in *PublishEventRequest, opts ...grpc.CallOption) (*PublishEventReply, error) {
...
func (UnimplementedEventServiceServer) PublishEvent(context.Context, *PublishEventRequest) (*PublishEventReply, error) {
